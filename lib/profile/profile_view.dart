                            ...
                            return Stepper(
                                ...
                                switch (_currentStep) {
                                  ...
                                  case 1:
                                    final PhoneAuthCredential credential =
                                        PhoneAuthProvider.credential(
                                            ...
                                            smsCode: smsCode);
                                    login(credential, runLoginMutation);

                                    break;

                                  case 2:
                                    final input =
                                        UpdateDriverInput(gender: driver.gender)
                                            .toJson();
                                  ...
                                  case 5:
                                    final inp = SetDocumentsOnDriverArguments(
                                        driverId: driver.id,
                                        relationIds: driver.documents
                                            .map((e) => e.id)
                                            .toList());
                                    await runSetDocumentsMutation(inp.toJson())
                                        .networkResult;
                                    showDialog(
                                        context: context,
                              ...
                              steps: <Step>[
                                Step(
                                  ...
                                  title: Text(S.of(context).cell_number),
                                  content: Column(
                                    children: [
                                      Row(
                                        children: [
                                        ...
                                        child: Column(children: [
                                          ...
                                          DropdownButtonFormField<String>(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              fillColor: Colors.white,
                                              isDense: true,
                                              hintText: S.of(context).car_color,
                                              enabledBorder: OutlineInputBorder(
                                                borderRadius:
                                                    BorderRadius.circular(10),
                                                borderSide: BorderSide(
                                      ...
                                      child: Column(children: [
                                        ...
                                        TextFormField(
                                          initialValue:
                                              driver.certificateNumber,
                                          onChanged: (value) =>
                                              driver.certificateNumber = value,
                                          decoration: InputDecoration(
                                            filled: true,
                                            fillColor: Colors.white,
                                            isDense: true,
